...
<body>
	...
	<div class="container">
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<c:forEach items="${free}" var="fr">
					<tr class="text-center">
						<td>${fr.boNo}</td>
						<td>${fr.boCategoryNm}</td>
						<td class="text-left"><a href="freeView.wow?boNo=${fr.boNo}">${fr.boTitle}
						</a></td>
						<td>${fr.boWriter}</td>
						<td>${fr.boRegDate}</td>
						<td>${fr.boHit}</td>
		...
		<!-- START : 페이지네이션  -->
			<mytag:paging pagingVO="${searchVO}" linkPage="freeList.wow?curPage="/>
		<!-- END : 페이지네이션  -->
